...
export class Modal implements IModal {
  ...
  constructor(modalContainer: HTMLElement, protected events: IEvents) {
    ...
    // Предотвращение закрытия при клике 
    this.modalContainer.querySelector('.modal__container').addEventListener('click', (event) => {
      event.stopPropagation();
    });
  }

  // Устанавление одержимого в модальное окно
  ...
  // Блокировка страницы при открытом окне
